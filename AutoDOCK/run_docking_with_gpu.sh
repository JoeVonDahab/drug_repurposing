...
LIGAND_DIR="ligands_pdbqt_part1"

# 4. Name of the directory where docking results (DLG files) will be saved
OUTPUT_DIR="docking_results_part1"

# 5. Docking run parameters
NUM_RUNS="10"              # Number of docking runs per ligand
DEVICE_NUMBER="1"          # !!! SET THIS to the GPU device number (e.g., 1 for the first GPU, 2 for the second) !!!
